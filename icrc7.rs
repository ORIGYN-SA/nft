...
impl Service {
  ...
  pub async fn icrc_7_token_metadata(&self, arg0: Vec<candid::Nat>) -> Result<(Vec<Option<Vec<(String,Value,)>>>,)> {
    ic_cdk::call(self.0, "icrc7_token_metadata", (arg0,)).await
  }
  pub async fn icrc_7_tokens(&self, arg0: Option<candid::Nat>, arg1: Option<candid::Nat>) -> Result<(Vec<candid::Nat>,)> {
    ic_cdk::call(self.0, "icrc7_tokens", (arg0,arg1,)).await
  }
  pub async fn icrc_7_tokens_of(&self, arg0: Account, arg1: Option<candid::Nat>, arg2: Option<candid::Nat>) -> Result<(Vec<candid::Nat>,)> {
  ...
  pub async fn icrc_7_transfer(&self, arg0: Vec<TransferArg>) -> Result<(Vec<Option<TransferResult>>,)> {
