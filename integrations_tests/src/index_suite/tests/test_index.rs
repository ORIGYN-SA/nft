...
use core_nft_api_api::types::update_nft_metadata::Args as UpdateTokenMetadataArg;
...
fn test_get_blocks_complex_filters_and_ordering() {
    ...
    let blocks_desc = get_blocks(
        ...
        &Args {
            ...
            length: 20,
            filters: vec![],
            sort_by: Some(index_icrc7_api::index::SortBy::Descending),
        },
    );
    ...
    let blocks_mint_asc = get_blocks(
        ...
        &Args {
            start: 0,
            length: 20,
            filters: vec![index_icrc7_api::index::IndexType::BlockType(
                "7mint".to_string(),
            )],
            sort_by: Some(index_icrc7_api::index::SortBy::Ascending),
        },
