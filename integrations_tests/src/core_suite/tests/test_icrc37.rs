...
use core_nft_common::icrc37_approve_tokens::ApproveTokenResult;
...
fn test_icrc37_approve_collection() {
    ...
    let approvals: core_nft_common::types::icrc37::icrc37_get_collection_approvals::Response =
...
fn test_icrc37_revoke_token_approvals_max_limit() {
    ...
    match mint_return {
        Ok(token_id) => {
            ...
            let approvals: core_nft_common::types::icrc37::icrc37_get_token_approvals::Response =
            ...
            let remaining_approvals: core_nft_common::types::icrc37::icrc37_get_token_approvals::Response =
                crate::client::pocket::unwrap_response(pic.query_call(
                    collection_canister_id,
                    controller,
                    "icrc37_get_token_approvals",
...
fn test_icrc37_revoke_collection_approvals_max_limit() {
    ...
    let remaining_approvals: core_nft_common::types::icrc37::icrc37_get_collection_approvals::Response =
        crate::client::pocket::unwrap_response(
            pic.query_call(
                collection_canister_id,
                controller,
...
fn test_icrc37_approvals_reset_after_transfer_as_owner() {
    ...
    match mint_return {
        Ok(token_id) => {
            ...
            let token_approvals: core_nft_common::types::icrc37::icrc37_get_token_approvals::Response =
                crate::client::pocket::unwrap_response(pic.query_call(
                    collection_canister_id,
                    controller,
                    "icrc37_get_token_approvals",
...
fn test_icrc37_approvals_reset_after_transfer_with_approvals() {
    ...
    match mint_return {
        Ok(token_id) => {
            ...
            let collection_approvals: core_nft_common::types::icrc37::icrc37_get_collection_approvals::Response =
            crate::client::pocket::unwrap_response(pic.query_call(
                collection_canister_id,
                controller,
                "icrc37_get_collection_approvals",
...
fn test_icrc37_approvals_persistence_after_upgrade() {
    ...
    match mint_return {
        Ok(token_id) => {
            ...
            let token_approvals_before: core_nft_common::types::icrc37::icrc37_get_token_approvals::Response =
                crate::client::pocket::unwrap_response(pic.query_call(
                    collection_canister_id,
                    controller,
                    "icrc37_get_token_approvals",
            ...
            let collection_approvals_before: core_nft_common::types::icrc37::icrc37_get_collection_approvals::Response =
                crate::client::pocket::unwrap_response(
                    pic.query_call(
                        collection_canister_id,
                        controller,
            ...
            let token_approvals_after: core_nft_common::types::icrc37::icrc37_get_token_approvals::Response =
                crate::client::pocket::unwrap_response(pic.query_call(
                    collection_canister_id,
                    controller,
                    "icrc37_get_token_approvals",
            ...
            let collection_approvals_after: core_nft_common::types::icrc37::icrc37_get_collection_approvals::Response =
                crate::client::pocket::unwrap_response(
                    pic.query_call(
                        collection_canister_id,
                        controller,
